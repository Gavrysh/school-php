<div class="wrapper-applications books">
  <h1>Каталог книжок<span>Загальна кількість на сторінці <?php echo (isset($books) ? $books->num_rows : $authors->num_rows) ?> шт.</span></h1>
  ...
  <div class="top">
    <div class="top-left">
      <form action="" method="post">
        <input type="submit" name="authors" value="Список авторів" class="search-btn">
      </form>
    </div>
  ...
  <form action="" method="post">
    <div class="actions-panel">
      <div class="ap-add">
        <input type="submit" name="booksAdd" value="Додати книжку" class="search-btn">
      </div>
      <div class="ap-delete">
        <input type="submit" name="booksDelete" value="Видалити відмічені книжки" class="search-btn">
      </div>
    </div>
