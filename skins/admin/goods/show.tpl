<div class="wrapper-applications">
  ...
  <form action="" method="post">  
    <input type="submit" name="delete" value="Видалити товар">
    <input type="submit" name="edit" value="Редагувати товар"><hr>
    <div class="inner-wrap goods-show">
      ...
      <div class="goods-show-footer">
        <p><a href="/admin/goods">Повернутися до списку товарів</a></p>
      </div>
    </div>
  </form>
</div>