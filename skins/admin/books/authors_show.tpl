<div class="wrapper-applications">
  ...
  <form action="" method="post">  
    <input type="submit" name="delete" value="Видалити автора">
    <input type="submit" name="edit" value="Редагувати автора"><hr>
    <div class="inner-wrap books-show">
      ...
      <div class="books-show-central-side">
        ...
        <p>
          <span>Твори письменника:
            <?php
              if (isset($a)) {
                foreach($a as $key => $val) {
                  echo '<br><a href="/admin/books/show/'.$a[$key]['id'].'">'.hs($a[$key]['name']).'</a>';
                }
              }
            ?>
          </span>
      ...
      <div class="books-show-footer">
        <p><a href="/admin/books/authors">Повернутися до списку авторів</a></p>
      </div>
    </div>
  </form>
</div>